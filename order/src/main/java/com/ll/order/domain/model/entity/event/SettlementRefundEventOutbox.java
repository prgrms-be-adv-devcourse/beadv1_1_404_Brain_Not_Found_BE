...
public class SettlementRefundEventOutbox extends BaseEntity {
    ...
    public static SettlementRefundEventOutbox from(RefundEvent refundEvent, String orderCode, ObjectMapper objectMapper) {
        try {
            String eventPayload = objectMapper.writeValueAsString(refundEvent);
            return SettlementRefundEventOutbox.builder()
                    .orderCode(orderCode)
